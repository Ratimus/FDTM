...
//
const uint16_t DOUBLECLICKTIME(250);  // Count two clicks as doubleclick if both received within this time
const uint16_t PRESSTIME(350);
const uint16_t HOLDTIME(1000);        // Report held button after time
